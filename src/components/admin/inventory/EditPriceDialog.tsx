...
import { ScrollArea } from '@/components/ui/scroll-area'; // For potentially long distributor lists
      ...
      <DialogContent className="sm:max-w-lg max-h-[80vh] flex flex-col">
        <DialogHeader>
          ...
          <DialogDescription>
            ...
            <br/>
            <span className="text-xs text-muted-foreground">Últ. Compra: {formatCurrency(product.lastPurchasePrice ?? 0)} | Stock: {product.quantity ?? 0}</span>
          </DialogDescription>
        </DialogHeader>
        ...
        <DialogFooter className="mt-auto pt-4 border-t"> {/* Ensure footer is at bottom */}
          ...
          <Button onClick={form.handleSubmit(onSubmit)} disabled={isSaving || distributors.length === 0} className="bg-primary hover:bg-primary/90">
